    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="date" name="date_of_birth" value="<?= e(!empty($student['date_of_birth']) ? date('Y-m-d', strtotime($student['date_of_birth'])) : '') ?>" required class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
