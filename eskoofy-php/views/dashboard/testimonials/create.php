<?php $pageTitle = 'New Testimonial'; ?>
<?php ob_start(); ?>

<div class="flex justify-between items-center mb-6">
    <h1 class="text-2xl font-bold text-gray-800">New Testimonial</h1>
    ...
    <form action="/dashboard/testimonials" method="POST" class="space-y-4">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="name" required maxlength="255" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500">
            </div>
        </div>
        <div class="grid md:grid-cols-2 gap-4">
            <div>
        ...
        <div>
            ...
            <textarea name="body" rows="4" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500"></textarea>
        </div>
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Author name</label>
                <input type="text" name="author_name" maxlength="255" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Author designation</label>
                <input type="text" name="author_designation" maxlength="255" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500">
            </div>
        </div>
        <div>
        ...
        <div class="flex justify-end gap-2">
            ...
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">Create</button>
        </div>
    </form>
</div>
