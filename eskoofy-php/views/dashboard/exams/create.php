<?php $pageTitle = 'Create Exam'; ?>
<?php ob_start(); ?>

<div class="flex justify-between items-center mb-6">
    <h1 class="text-2xl font-bold text-gray-800">Create Exam</h1>
    <a href="/dashboard/exams" class="text-gray-600 hover:text-gray-800">← Back to Exams</a>
</div>

<div class="bg-white rounded-xl shadow-sm p-6">
    <form action="/dashboard/exams" method="POST" class="space-y-4">
        <?= csrf_field() ?>
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="date" name="start_date" value="<?= old('start_date') ?>" required class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">End Date *</label>
                <input type="date" name="end_date" value="<?= old('end_date') ?>" required class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500">
            </div>
        ...
        <div class="flex justify-end space-x-4">
            <a href="/dashboard/exams" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">Cancel</a>
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">Create Exam</button>
        </div>
    </form>
</div>
