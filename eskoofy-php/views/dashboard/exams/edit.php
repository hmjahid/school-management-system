    ...
    <form action="/dashboard/exams/<?= e($exam['id']) ?>" method="POST" class="space-y-4">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="date" name="start_date" value="<?= e(date('Y-m-d', strtotime($exam['start_date']))) ?>" required class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">End Date *</label>
                <input type="date" name="end_date" value="<?= e(date('Y-m-d', strtotime($exam['end_date']))) ?>" required class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500">
            </div>
