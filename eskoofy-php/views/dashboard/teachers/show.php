...
<div class="flex justify-between items-center mb-6">
    <div>
        ...
        <p class="text-gray-500">ID: <?= e($teacher->teacher_id) ?> | Subject: <?= e($teacher->subject->name ?? '') ?></p>
    </div>
...
<div class="grid md:grid-cols-2 gap-6">
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        <dl class="space-y-2">
            ...
            <div class="flex"><dt class="w-40 text-gray-500">Date of Birth:</dt><dd class="font-medium"><?= e($teacher->date_of_birth ? $teacher->date_of_birth->format('M d, Y') : '-') ?></dd></div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        <dl class="space-y-2">
            <div class="flex"><dt class="w-40 text-gray-500">Teacher ID:</dt><dd class="font-medium"><?= e($teacher->teacher_id) ?></dd></div>
            <div class="flex"><dt class="w-40 text-gray-500">Subject:</dt><dd class="font-medium"><?= e($teacher->subject->name ?? '-') ?></dd></div>
            ...
            <div class="flex"><dt class="w-40 text-gray-500">Joining Date:</dt><dd class="font-medium"><?= e($teacher->joining_date ? $teacher->joining_date->format('M d, Y') : '-') ?></dd></div>
        ...
        <table class="w-full text-left">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    <td class="py-3 px-4"><?= e($assignment->class->name ?? '') ?></td>
                    <td class="py-3 px-4"><?= e($assignment->section->name ?? '') ?></td>
                    <td class="py-3 px-4"><?= e($assignment->subject->name ?? '') ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
