...
<div class="flex justify-between items-center mb-6">
    <div>
        ...
        <p class="text-gray-500">Applied: <?= e($admission->created_at->format('M d, Y')) ?></p>
    </div>
...
<div class="grid md:grid-cols-2 gap-6">
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        <dl class="space-y-2 text-sm">
            ...
            <div class="flex"><dt class="w-36 text-gray-500">DOB:</dt><dd class="font-medium"><?= e($admission->date_of_birth ? $admission->date_of_birth->format('M d, Y') : '-') ?></dd></div>
            <div class="flex"><dt class="w-36 text-gray-500">Gender:</dt><dd class="font-medium"><?= e(ucfirst($admission->gender ?? '')) ?></dd></div>
            <div class="flex"><dt class="w-36 text-gray-500">Class:</dt><dd class="font-medium"><?= e($admission->class->name ?? '') ?></dd></div>
