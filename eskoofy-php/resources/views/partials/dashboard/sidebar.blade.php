            ...
            <details class="group" @if (request()->routeIs('dashboard.fees*') || request()->routeIs('dashboard.fee-payments*') || request()->routeIs('dashboard.expenses*') || request()->routeIs('dashboard.expense-categories*') || request()->routeIs('dashboard.budgets*') || request()->routeIs('dashboard.ledger*') || request()->routeIs('dashboard.bank-reconciliation*') || request()->routeIs('dashboard.reports.income-statement') || request()->routeIs('dashboard.reports.balance-sheet') || request()->routeIs('dashboard.reports.cash-flow')) open @endif>
                ...
                <div class="ml-4 mt-1 space-y-0.5 border-l border-slate-200 pl-3 dark:border-slate-700">
                    ...
                    @can('manage_expenses')
                        ...
                        <a href="{{ route('dashboard.expense-categories.index') }}" class="block rounded-lg py-2 pl-2 text-sm {{ request()->routeIs('dashboard.expense-categories*') ? 'font-semibold text-brand-700 dark:text-brand-400' : 'text-slate-600 hover:text-brand-600 dark:text-slate-400 dark:hover:text-brand-400' }}">{{ __('dashboard.expense_categories') }}</a>
                        <a href="{{ route('dashboard.budgets.index') }}" class="block rounded-lg py-2 pl-2 text-sm {{ request()->routeIs('dashboard.budgets*') ? 'font-semibold text-brand-700 dark:text-brand-400' : 'text-slate-600 hover:text-brand-600 dark:text-slate-400 dark:hover:text-brand-400' }}">{{ __('dashboard.budgets') }}</a>
                        <a href="{{ route('dashboard.bank-reconciliation.index') }}" class="block rounded-lg py-2 pl-2 text-sm {{ request()->routeIs('dashboard.bank-reconciliation*') ? 'font-semibold text-brand-700 dark:text-brand-400' : 'text-slate-600 hover:text-brand-600 dark:text-slate-400 dark:hover:text-brand-400' }}">{{ __('dashboard.bank_reconciliation') }}</a>
                        <a href="{{ route('dashboard.reports.income-statement') }}" class="block rounded-lg py-2 pl-2 text-sm {{ request()->routeIs('dashboard.reports.income-statement') ? 'font-semibold text-brand-700 dark:text-brand-400' : 'text-slate-600 hover:text-brand-600 dark:text-slate-400 dark:hover:text-brand-400' }}">{{ __('dashboard.income_statement') }}</a>
                        <a href="{{ route('dashboard.reports.balance-sheet') }}" class="block rounded-lg py-2 pl-2 text-sm {{ request()->routeIs('dashboard.reports.balance-sheet') ? 'font-semibold text-brand-700 dark:text-brand-400' : 'text-slate-600 hover:text-brand-600 dark:text-slate-400 dark:hover:text-brand-400' }}">{{ __('dashboard.balance_sheet') }}</a>
                        <a href="{{ route('dashboard.reports.cash-flow') }}" class="block rounded-lg py-2 pl-2 text-sm {{ request()->routeIs('dashboard.reports.cash-flow') ? 'font-semibold text-brand-700 dark:text-brand-400' : 'text-slate-600 hover:text-brand-600 dark:text-slate-400 dark:hover:text-brand-400' }}">{{ __('dashboard.cash_flow') }}</a>
                    @endcan
        ...
        @if ($isAdmin ?? auth()->user()?->hasRole('admin'))
            ...
            <details class="group" @if (request()->routeIs('dashboard.cms.*') || request()->routeIs('dashboard.contact-submissions') || request()->routeIs('dashboard.careers.*') || request()->routeIs('dashboard.news.*') || request()->routeIs('dashboard.gallery.*') || request()->routeIs('dashboard.announcements.*') || request()->routeIs('dashboard.notices.*') || request()->routeIs('dashboard.documents.*') || request()->routeIs('dashboard.media.*') || request()->routeIs('dashboard.settings.cms') || request()->routeIs('dashboard.settings.global-labels')) open @endif>
                ...
                <div class="ml-4 mt-1 space-y-0.5 border-l border-slate-200 pl-3 dark:border-slate-700">
                    ...
                    <a href="{{ route('dashboard.careers.postings') }}" class="block rounded-lg py-2 pl-2 text-sm {{ request()->routeIs('dashboard.careers.postings') || request()->routeIs('dashboard.careers.create') || request()->routeIs('dashboard.careers.edit') ? 'font-semibold text-brand-700 dark:text-brand-400' : 'text-slate-600 hover:text-brand-600 dark:text-slate-400 dark:hover:text-brand-400' }}">{{ __('dashboard.careers') }}</a>
                    <a href="{{ route('dashboard.careers.applications') }}" class="block rounded-lg py-2 pl-2 text-sm {{ request()->routeIs('dashboard.careers.applications') || request()->routeIs('dashboard.careers.show') ? 'font-semibold text-brand-700 dark:text-brand-400' : 'text-slate-600 hover:text-brand-600 dark:text-slate-400 dark:hover:text-brand-400' }}">{{ __('dashboard.job_applications') }}</a>
                </div>
            </details>
            ...
            <x-admin-nav-link :href="route('dashboard.reports')" route-is="dashboard.reports|dashboard.reports.fees|dashboard.reports.attendance|dashboard.reports.students|dashboard.reports.export" :icon="'<svg class=\'h-5 w-5\' fill=\'currentColor\' viewBox=\'0 0 20 20\'><path d=\'M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z\'/></svg>'">{{ __('dashboard.reports') }}</x-admin-nav-link>
            <x-admin-nav-link :href="route('dashboard.reports.builder')" route-is="dashboard.reports.builder*" :icon="'<svg class=\'h-5 w-5\' fill=\'currentColor\' viewBox=\'0 0 20 20\'><path fill-rule=\'evenodd\' d=\'M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V4a2 2 0 00-2-2H6zm0 9a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z\' clip-rule=\'evenodd\'/></svg>'">{{ __('dashboard.report_builder') }}</x-admin-nav-link>
            <x-admin-nav-link :href="route('dashboard.analytics')" route-is="dashboard.analytics" :icon="'<svg class=\'h-5 w-5\' fill=\'currentColor\' viewBox=\'0 0 20 20\'><path d=\'M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z\'/></svg>'">{{ __('dashboard.analytics') }}</x-admin-nav-link>
