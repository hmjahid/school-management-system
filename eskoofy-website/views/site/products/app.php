...
<section class="esk-hero text-white">
    <div class="max-w-7xl mx-auto px-4 py-16">
        <span class="text-xs uppercase tracking-widest bg-blue-500/20 text-blue-200 px-3 py-1 rounded-full"><?= __('pricing.app_section') ?></span>
        <h1 class="text-4xl md:text-5xl font-extrabold mt-4"><?= __('product.app_title') ?></h1>
        <p class="mt-4 text-slate-300 text-lg max-w-2xl"><?= __('product.app_sub') ?></p>
    </div>
</section>
...
<section class="max-w-7xl mx-auto px-4 pb-16">
    <div class="bg-white rounded-2xl border border-slate-200 p-8">
        <h2 class="text-2xl font-bold mb-4"><?= __('product.app_features') ?></h2>
