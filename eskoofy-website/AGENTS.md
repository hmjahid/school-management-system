...
This is the **`eskoofy-website`** product folder inside the Eskoofy monorepo (root `AGENTS.md`).
...
- `app/` — reuses the zero-dependency `eskoofy-php/app/Core` (Router, Database,
...
See `eskoofy-website/README.md` for the full feature list and environment reference.