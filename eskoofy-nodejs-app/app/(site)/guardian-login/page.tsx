...
export default async function GuardianLoginPage({
  ...
  const action = roleLoginAction("guardian");

  return (
    <section className="mx-auto flex max-w-md flex-col px-4 py-20">
      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-lg">
        <h1 className="text-2xl font-semibold text-slate-900">Guardian Login</h1>
        <p className="mt-2 text-sm text-slate-500">Sign in to follow your child&apos;s attendance, results and fees.</p>
