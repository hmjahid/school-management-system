...
/**
 * Minimal Blade-compatible template engine (compiler + runtime) so eskoofy-php-app
 * can reuse the exact Blade views from eskoofy-laravel-app without a framework.
 *
