...
/**
 * Allow-list HTML sanitizer for rich-text content rendered with `{!! !!}`
 * in the shared Blade templates (news bodies, notification/email templates).
 * Parity port of eskoofy-laravel-app/app/Services/HtmlSanitizer.php.
 */
class HtmlSanitizer
{
