    ...
    <div class="grid gap-4 sm:grid-cols-2">
        <div>
            ...
            <input type="text" id="cms-title-en" name="title_en" value="{{ old('title_en', $content->title_en ?? $content->title) }}" required
                class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500">
        </div>
        <div>
        ...
        <div>
            ...
            <textarea id="cms-meta-en" name="meta_description_en" rows="2"
                class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500">{{ old('meta_description_en', $content->meta_description_en ?? '') }}</textarea>
        </div>
        <div>
            ...
            <textarea id="cms-meta-bn" name="meta_description_bn" rows="2"
                class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500">{{ old('meta_description_bn', $content->meta_description_bn ?? '') }}</textarea>
        </div>
    </div>
</section>
