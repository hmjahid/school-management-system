...
> Product: `eskoofy-php-app` (raw PHP 8.2+, PDO/MySQL, no framework at runtime) · This guide covers install, database, configuration, web server, cron and maintenance.
...
- **nginx:**
  ...
  ```nginx
  root /path/to/eskoofy-php-app/public;
