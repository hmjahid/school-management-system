...
> Product: `eskoofy-php-app` (raw PHP 8.2+, no framework at runtime) · Audience: school staff, administrators, accountants, librarians, teachers, students & guardians · Docs language: English
...
student/guardian portals and the same JSON API** as `eskoofy-laravel-app`, rendering the **byte-identical
...
|---|---|---|
| Test suite | `cd eskoofy-php-app && composer test` | ✅ **314 tests passed** (807 assertions) |
