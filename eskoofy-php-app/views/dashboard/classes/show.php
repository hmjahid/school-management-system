...
<div class="grid md:grid-cols-3 gap-6 mb-6">
    <div class="bg-white rounded-xl shadow-sm p-6 text-center">
        <div class="text-3xl font-bold text-blue-600"><?= e((int)($class['sections_count'] ?? 0)) ?></div>
        <div class="text-gray-500">Sections</div>
    </div>
    <div class="bg-white rounded-xl shadow-sm p-6 text-center">
        <div class="text-3xl font-bold text-green-600"><?= e((int)($class['students_count'] ?? 0)) ?></div>
        <div class="text-gray-500">Total Students</div>
    </div>
    <div class="bg-white rounded-xl shadow-sm p-6 text-center">
        <div class="text-3xl font-bold text-purple-600"><?= e((int)($class['teachers_count'] ?? 0)) ?></div>
...
<div class="bg-white rounded-xl shadow-sm p-6 mb-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition">
                    ...
                    <p class="text-sm text-gray-500">Teacher: <?= e($section['teacher_name'] ?? 'Not assigned') ?></p>
                </div>
                <?php endforeach; ?>
    </div>
    <?php else: ?>
        ...
        <table class="w-full text-left">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    <td class="py-3 px-4"><?= e($student['roll_number'] ?? $student['roll'] ?? '-') ?></td>
