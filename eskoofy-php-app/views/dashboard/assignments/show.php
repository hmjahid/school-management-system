...
<div class="flex justify-between items-center mb-6">
    <div>
        ...
        <p class="text-gray-500"><?= e($assignment['subject_name'] ?? '') ?> | Due: <?= e(date('M d, Y H:i', strtotime($assignment['due_date'] ?? 'now'))) ?></p>
    </div>
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    <div class="p-6 border-b">
        <h2 class="text-lg font-bold">Submissions (<?= e(is_array($submissions) ? count($submissions) : 0) ?>)</h2>
    </div>
        ...
        <table class="w-full text-left">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    <td class="py-3 px-4"><?= e($submission['student_name'] ?? '') ?></td>
                    <td class="py-3 px-4 text-sm"><?= e(date('M d, Y H:i', strtotime($submission['submitted_at'] ?? 'now'))) ?></td>
