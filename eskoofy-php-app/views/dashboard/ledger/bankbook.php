<?php $pageTitle = 'Bank Book'; ?>
<?php ob_start(); ?>

<div class="flex justify-between items-center mb-6">
    <h1 class="text-2xl font-bold text-gray-800">Bank Book</h1>
...
<div class="flex space-x-2 mb-6">
    ...
    <a href="/dashboard/ledger/bankbook" class="bg-blue-100 text-blue-700 px-4 py-2 rounded-lg">Bank Book</a>
...
<div class="bg-white rounded-xl shadow-sm p-6 mb-6">
    <form action="/dashboard/ledger/bankbook" method="GET" class="flex flex-col sm:flex-row gap-4">
        <div>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left">
            ...
            <tbody>
                ...
                <?php endforeach; ?>
                <?php if (empty($rows)): ?>
                <tr><td colspan="6" class="py-8 text-center text-gray-500">No bank transactions found.</td></tr>
                <?php endif; ?>
            </tbody>
            <tfoot>
