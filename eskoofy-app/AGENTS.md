...
This is the **`eskoofy-app`** product folder inside the Eskoofy monorepo (root `AGENTS.md`).
Work here is the Laravel 12 school management software.

## Project structure

- This folder (`eskoofy-app/`) = the whole app (Laravel 12, PHP 8.2+). Standard Laravel layout — `app/`, `config/`, `routes/`, `resources/`, `public/`, etc.
