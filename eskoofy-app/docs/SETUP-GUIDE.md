...
> Product: `eskoofy-app` (Laravel 12, PHP 8.2+) · This guide covers install, database, configuration, deployment and maintenance.
...
- Point the document root at `eskoofy-app/public`.
