    ...
    <div class="mb-8" data-help-search-wrap>
        <div class="relative max-w-xl">
            ...
            <input type="search" data-help-search placeholder="{{ __('dashboard.help.search_placeholder') }}"
                class="w-full rounded-xl border border-slate-200 bg-white py-3 pl-12 pr-4 text-sm text-slate-900 placeholder:text-slate-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 shadow-sm dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500">
        </div>
    </div>
                ...
                <button type="button" class="flex w-full items-center gap-4 px-6 py-5 text-left transition hover:bg-slate-50 dark:hover:bg-slate-700/50" data-help-toggle>
                    @php
                        $colors = [
                            ...
                            'managing_teachers' => ['bg' => 'bg-brand-100 dark:bg-brand-900/40', 'text' => 'text-brand-600 dark:text-brand-400', 'icon' => '<path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3z"/>'],
