<section class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
    <header class="mb-4">
        ...
        <p class="mt-1 text-xs text-gray-500">{{ __('These appear in browser tabs and search results. The Bengali title is optional; leave empty to use the English one.') }}</p>
    </header>
    <div class="grid gap-4 sm:grid-cols-2">
        ...
        <div>
            <label for="cms-title-bn" class="mb-1 block text-sm font-medium text-gray-700">{{ __('Page title (Bengali)') }}</label>
        ...
        <div>
            <label for="cms-meta-bn" class="mb-1 block text-sm font-medium text-gray-700">{{ __('Meta description (Bengali)') }}</label>
