    ...
    <div class="space-y-1">
        ...
        @can('viewAny', App\Models\Event::class)
            <a href="{{ route('dashboard.events') }}"
                class="{{ request()->routeIs('dashboard.events*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} flex items-center rounded-md px-3 py-2 text-sm font-medium">
                <svg class="mr-3 h-5 w-5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"/></svg>
                {{ __('Events') }}
            </a>
        @endcan
        ...
        @if ($isAdmin)
            ...
            <a href="{{ route('dashboard.reports') }}"
                class="{{ request()->routeIs('dashboard.reports*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} flex items-center rounded-md px-3 py-2 text-sm font-medium">
                <svg class="mr-3 h-5 w-5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z"/></svg>
                {{ __('Reports') }}
            </a>

            <a href="{{ route('dashboard.bulk') }}"
                class="{{ request()->routeIs('dashboard.bulk*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} flex items-center rounded-md px-3 py-2 text-sm font-medium">
                <svg class="mr-3 h-5 w-5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM6.293 6.707a1 1 0 010-1.414l3-3a1 1 0 011.414 0l3 3a1 1 0 01-1.414 1.414L11 5.414V13a1 1 0 11-2 0V5.414L7.707 6.707a1 1 0 01-1.414 0z" clip-rule="evenodd"/></svg>
                {{ __('Bulk import / export') }}
            </a>
        @endif
    </div>
</nav>
