...
-- 8b. VISITORS (public-site page-view log for the admin dashboard)
CREATE TABLE IF NOT EXISTS `visitors` (
  ...
  `updated_at` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
  KEY `visitors_visited_at_index` (`visited_at`),
  KEY `visitors_path_index` (`path`),
...
('site.support_email',   'support@eskoofy.com', 'site', NOW(), NOW()),
('site.sales_email',     'sales@eskoofy.com',   'site', NOW(), NOW()),
('site.support_phone',   '+880 9610-000000',    'site', NOW(), NOW()),
('site.whatsapp',        '+8801700000000',      'site', NOW(), NOW()),
('site.address',         'Level 4, Eskoofy House, Dhaka, Bangladesh', 'site', NOW(), NOW()),
('site.support_hours',   'Sunday–Thursday, 9:00–18:00 (UTC+6)', 'site', NOW(), NOW()),
('site.social_facebook', '',                    'site', NOW(), NOW()),
('site.social_instagram', '',                   'site', NOW(), NOW()),
('site.social_twitter',  '',                    'site', NOW(), NOW()),
('site.social_linkedin', '',                    'site', NOW(), NOW()),
('site.social_youtube',  '',                    'site', NOW(), NOW()),
('support.widget_enabled', '1',                 'support', NOW(), NOW()),
('visitors.logging_enabled', '1',               'visitors', NOW(), NOW());
