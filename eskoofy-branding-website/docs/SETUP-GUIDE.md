...
> Component: `eskoofy-branding-website` (raw PHP 8.2+, front-controller app, no framework at runtime) · This guide covers install, database, configuration, license-server settings, web server and maintenance.
...
```nginx
root /path/to/eskoofy-branding-website/public;
