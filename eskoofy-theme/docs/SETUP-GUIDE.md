...
> Product: `eskoofy-theme` (WordPress theme, v0.2.0, text domain `eskoofy`) · This guide covers install, activation, database, configuration and deployment.
...
1. Copy the theme folder into WordPress:
   ...
   ```bash
   cp -r eskoofy-theme /path/to/wp-content/themes/eskoofy
   ```
