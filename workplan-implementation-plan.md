...
Verification baseline (2026-09-11): `cd eskoofy-app && composer test` → **923 passed, 2361 assertions**; `cd eskoofy-php && composer test` → **248 passed, 444 assertions**; `cd eskoofy-website && composer test` → **79 passed, 214 assertions**; `pint --test` clean on all touched files.
...
| eskoofy-php (Raw PHP) | 402 | Core (16), Models (78), Controllers (67+11 API), Gateways (9), Views (173), Config (3), Lang (6), Schema (93 tables), Tests (18 files / 255 cases / 463 assertions) |
