...
<div class="{{ $wrapperClass ?? 'mt-1' }}">
    <label for="{{ $fileId }}" class="inline-flex cursor-pointer items-center gap-2 rounded-lg bg-brand-600 px-5 py-2.5 text-sm font-semibold text-white shadow-md transition hover:bg-brand-700 focus-within:outline focus-within:ring-2 focus-within:ring-brand-500 focus-within:ring-offset-2">
