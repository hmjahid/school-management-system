...
<div class="flex min-h-[60vh] items-center justify-center px-4">
    <div class="text-center max-w-lg">
        ...
        <div class="mt-8 flex justify-center gap-4">
            ...
            <a href="{{ route('contact') }}" class="rounded-lg border border-slate-300 bg-white px-6 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50">Report Issue</a>
        </div>
    </div>
</div>
@endsection
