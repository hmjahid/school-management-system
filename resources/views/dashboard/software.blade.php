...
@section('content')
    <div class="mx-auto max-w-4xl space-y-6">
        {{-- Header --}}
        <div class="rounded-xl bg-gradient-to-r from-brand-600 to-purple-600 p-8 text-white shadow-lg">
            ...
            <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                ...
                @foreach($features as $f)
                    <div class="flex items-center gap-3 rounded-lg bg-gray-50 p-3">
                        <svg class="h-5 w-5 shrink-0 text-brand-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $f['icon'] }}"/></svg>
