            ...
            <div class="mt-10 reveal">
                @if($student && $result->isNotEmpty())
                    ...
                    <div class="mt-10 flex flex-wrap gap-3">
                        ...
                        <button onclick="alert('{{ __('Download functionality coming soon') }}')" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-6 py-3 text-sm font-semibold text-slate-700 shadow-sm transition-all hover:bg-slate-50 hover:shadow-md">
