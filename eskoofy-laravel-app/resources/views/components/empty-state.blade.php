@props([
    ...
    'message' => null,
    'icon' => 'inbox',         // heroicon name (without prefix)
    'cta' => null,             // ['label' => '...', 'url' => '...', 'permission' => '...']
])

@php
    // Simple inline SVG icon set — keeps the partial dependency-free.
    $iconPaths = [
        'inbox'    => 'M2.25 13.5h3.86a2.25 2.25 0 0 1 2.012 1.244l.256.512a2.25 2.25 0 0 0 2.013 1.244h3.218a2.25 2.25 0 0 0 2.013-1.244l.256-.512a2.25 2.25 0 0 1 2.013-1.244h3.859m-19.5 0V6.375c0-1.243 1.007-2.25 2.25-2.25h15c1.243 0 2.25 1.007 2.25 2.25v7.125m-19.5 0a2.25 2.25 0 0 0 2.25 2.25h15a2.25 2.25 0 0 0 2.25-2.25',
...
<div class="flex flex-col items-center justify-center text-center">
    ...
    @isset($cta)
        @if (!empty($cta['url']) && !empty($cta['label']))
            <a href="{{ $cta['url'] }}" class="mt-4 inline-flex items-center rounded-lg bg-brand-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-700">
                {{ $cta['label'] }}
            </a>
        @endif
    @endisset
