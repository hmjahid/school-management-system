...
@section('content')
    @if($siteSettings->section_visibility['transport_hero'] ?? true)
    ...
    <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        @if($siteSettings->section_visibility['transport_routes'] ?? true)
        @if($routes->isEmpty())
        ...
        @if($siteSettings->section_visibility['transport_fleet'] ?? true)
        ...
        @if($siteSettings->section_visibility['transport_map'] ?? true)
