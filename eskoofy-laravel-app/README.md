...
> `eskoofy-php-app/` (raw PHP, shared hosting) and `eskoofy-wp-theme/` (WordPress). Keep the
...
templates or the app's CSS/JS, remember they are mirrored by `eskoofy-php-app/` and
`eskoofy-wp-theme/`.
