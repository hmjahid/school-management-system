...
return [
    ...
    'help' => [
        ...
        'no' => 'No',
        'step' => 'Step :num',
        'help_search_topics' => 'Explore all topics',
        'help_view_docs' => 'View full documentation',
        'help_esc_close' => 'Press Esc to close',
        'sections' => [
            'getting_started' => [
    ...
    'fee_target_monthly' => 'Fee target (monthly)',
    ...
    'no_teacher_assignments' => 'No teacher assignments yet.',
];
